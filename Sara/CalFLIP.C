void CalFLIP(TString fname="DATA/FLIP/wave_0_reco.root"){
   ...
   TH1D* h1 = new TH1D("h1",";ToF1-ToF0 [samples]; Events",80,-56,-44);
   ToF0->Draw("ToF1.Time-ToF0.Time>>h1","","colz");
   h1->Fit("f1","L");  
   gPad->SetLogy();
   //h1->SetStats(1);
   c1->SaveAs("IMAGES/FLIP/ToF1ToF0.png");
   c1->Draw();
   ...
   TH1D* h2 = new TH1D("h2",";ToF2-ToF0 [samples]; Events",80,-35,-20);
   ToF0->Draw("ToF2.Time-ToF0.Time>>h2","","colz");
   h2->Fit("f2","L");
   gPad->SetLogy();
   c2->SaveAs("IMAGES/FLIP/ToF2ToF0.png");
   c2->Draw();
   ...
   TH1D* h3 = new TH1D("h3",";ToF3-ToF0 [samples]; Events",80,-36,-22);
   ToF0->Draw("ToF3.Time-ToF0.Time>>h3","","colz");
   //h3->Fit("f3","L", "");
   h3->Fit("gaus","L", "");
   gPad->SetLogy();
   c3->SaveAs("IMAGES/FLIP/ToF3ToF0.png");
   c3->Draw();
